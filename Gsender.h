...
class Gsender
{
    ...
    private:
        ...
        const char* EMAILBASE64_LOGIN = "Use base 64!!!"; // use this site https://www.base64encode.org/
        const char* EMAILBASE64_PASSWORD = "Use base 64!!!";// use this site https://www.base64encode.org/
        const char* FROM = "Gmail@gmail.com";
